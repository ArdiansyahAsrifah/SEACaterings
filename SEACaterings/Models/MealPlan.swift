...
struct MealPlan: Identifiable {
    ...
    static let samplePlans: [MealPlan] = [
        MealPlan(name: "Healthy Pack", price: "$39.99", originalPrice: "$49.99", description: "A balanced diet plan for a healthy lifestyle including fresh veggies, lean protein, and whole grains. This plan helps improve digestion and maintain energy throughout the day.", imageName: "health", category: "Balanced", rating: 4.8, isPopular: true, calories: "1800/day", servings: "3 meals"),
        MealPlan(name: "High Protein", price: "$49.99", originalPrice: nil, description: "Ideal for fitness enthusiasts. Includes chicken breast, eggs, legumes, and protein shakes to build and maintain muscle.", imageName: "protein", category: "Fitness", rating: 4.9, isPopular: false, calories: "2200/day", servings: "4 meals"),
